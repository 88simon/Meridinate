; ============================================================================
; Meridinate - Solana Analysis Toolkit
; ============================================================================
...
OpenSolscan(address) {
    ...
    excludeAmountZero := IniRead(settingsFile, "Solscan", "exclude_amount_zero", "true")
    removeSpam := IniRead(settingsFile, "Solscan", "remove_spam", "true")
    minValue := IniRead(settingsFile, "Solscan", "value", "100")
    tokenAddress := IniRead(settingsFile, "Solscan", "token_address", "So11111111111111111111111111111111111111111")
...
ReloadPageWithExclusions(mainAddress, exclusionsList) {
    ...
    for index, excludeAddr in exclusionsList {
        if (excludeAddr != "") {
            if (excludeParam != "") {
                excludeParam .= ","  ; Separator character
            }
            excludeParam .= "!" . excludeAddr  ; Exclusion prefix
        }
    }

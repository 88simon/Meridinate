...
This document outlines recommended branch protection rules for Meridinate to maintain code quality and security.
...
- ✅ **Require status checks to pass before merging**
  ...
  **Required status checks:**
  - `Backend Linting` (from CI workflow)
  - `Backend Tests` (from CI workflow)
  - `Lint Python Code` (from Backend CI workflow)
  - `Run Tests` (from Backend CI workflow)
  - `Analyze Python Code` (from CodeQL workflow)
  - `Build Docker Image` (from Docker Build workflow)
...
- ✅ **Require status checks to pass before merging**
  - Only require critical checks (linting + tests)
...
gh api repos/{owner}/{repo}/branches/main/protection \
  --method PUT \
  --field required_status_checks='{"strict":true,"contexts":["Backend Linting","Backend Tests","Lint Python Code","Run Tests","Analyze Python Code","Build Docker Image"]}' \
...
# Backend code
/backend/ @YOUR_USERNAME @backend-team

# CI/CD workflows
/.github/workflows/ @YOUR_USERNAME @devops-team

# Docker configuration
/Dockerfile @YOUR_USERNAME @devops-team
/docker-compose.yml @YOUR_USERNAME @devops-team

# Security and docs
/docs/SECURITY*.md @YOUR_USERNAME @security-team
```

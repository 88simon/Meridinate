...
Points to: `https://codecov.io/gh/88simon/meridinate-backend`
...
**Via GitHub Web UI:**
1. Go to: https://github.com/88simon/meridinate-backend/settings/secrets/actions
2. Look for `CODECOV_TOKEN` in the "Repository secrets" list
3. You won't see the value, but it should show "Updated X days ago"

**Via GitHub CLI:**
```bash
gh secret list --repo 88simon/meridinate-backend
```
...
```yaml
# Codecov configuration for Meridinate backend

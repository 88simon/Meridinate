...
export function SwabSettingsPanel({
  settings,
  onClose,
  onSave
}: SwabSettingsPanelProps) {
        ...
        <div className='space-y-6 p-4'>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-muted-foreground text-xs'>
              When enabled, positions are checked automatically at the interval
              below
            </p>
          </div>
          ...
          <div className='space-y-2'>
            ...
            />
            <p className='text-muted-foreground text-xs'>
              Maximum credits to spend on position checks per day (10 credits
              per check)
            </p>
          </div>
